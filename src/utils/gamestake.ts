...
// Re-exported, not re-declared. The chain id has one home — `SIGNING_CHAIN_ID`
// in src/data/wallet.ts — and a second literal here would be a number that can
// silently disagree with the one every guard actually checks.
